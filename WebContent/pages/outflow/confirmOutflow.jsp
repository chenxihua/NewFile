...
<body>
 ...
 <form class="layui-form" action="" method="post" name="myForm">  
  ...
  <div class="layui-form-item">
    <label class="layui-form-label" style="font-size: 13px;">处理时间</label>
    <div class="layui-input-block">
      <input type="text" name="" value="${outflow.handleTime}" style="color:#c2c2c2;" readonly="true" autocomplete="off" class="layui-input">
    </div>
  </div>  
  ...
  <div class="layui-form-item layui-form-text">
    ...
    <div class="layui-input-block">
      <textarea name="" class="layui-textarea" lay-verify="required" style="color:#c2c2c2;" readonly="true" >${outflow.deferMeasure}</textarea>
    </div>
  </div>
  ...
  <div class="layui-form-item layui-form-text">
    ...
    <div class="layui-input-block">
      <textarea name="reason" class="layui-textarea" lay-verify="required" >${outflow.reason}</textarea>
    </div>
  </div>
...
layui.use('form', function(){
	...
	form.on('submit(formDemo)', function(data){
		$.post("<%=basePath %>outflow/confirmOutflow.action",data.field,function(ret){
			if(ret.msg){
