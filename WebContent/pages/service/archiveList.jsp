...
<body>	
	...
	<form class="layui-form">		
		...
		<div class="layui-inline">
  		...
  		<div class="layui-inline">
			<label class="layui-form-label" style="width: 60px;">处理时间</label>
	...
	<script type="text/javascript" id="barDemo">
	  <a class="layui-btn layui-btn-xs" lay-event="feedbackService">填写反馈</a>
	</script>
	...
	<script>			
		layui.use(['form','layer','table'], function(){
          	...
          	table.render({
            	...
            	,url:'<%=basePath %>/service/archiveList'  //数据请求路径
            	,cellMinWidth: 80
            	,cols: [[
                  ...
                  ,{ field: 'content', width:180, title: '服务概要', sort: true}                    
  				  ...
  				  ,{ field: 'handlerUser',  templet:function(d){ if( d.handlerUser!=null ) return d.handlerUser.name; else return "";  }, width:90, title:'处理人', sort: true}
  				  //,{ field: 'result', width:180, title: '处理结果', sort: true}                    
                  ,{ field: 'handleTime', width:200, title: '处理时间', sort: true, templet:function(d){  if(d.handleTime!=null) return myTimeConverter(d.handleTime); else return ""; } }
  	...
  	table.on('tool(test)', function(obj){
    	...
    	//填写反馈
    	if(obj.event === 'feedbackService'){
  			layer.open({
  				title: ['填写反馈','font-size:18px'],
  		  		type: 2, 
                area : ['850px','550px'],
  		  		content: '<%=basePath %>service/toFeedbackService.action?id='+data.id ,
                end : function() {
                    table.reload('test',{});
                }
  			});  
