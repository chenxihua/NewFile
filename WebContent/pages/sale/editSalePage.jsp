...
<form class="layui-form" action="" lay-filter="example">
  ...
  <div class="layui-form-item">
    <div class="layui-input-block">
      <button class="layui-btn layui-btn-ms" name="demo1" lay-submit lay-filter="demo1">审核通过</button>
      <button class="layui-btn layui-btn-danger layui-btn-ms" name="demo2" lay-submit lay-filter="demo2">审核失败</button>
    </div>
  </div>
</form>
...
layui.use(['form', 'layedit', 'laydate'], function(){
  ...
  function updataSaleChanceById(id){
	...
	form.on('submit(demo1)',function(data){
	    ...
	    $.ajax({
	        type: "POST",
	        url: "saleChance/updateSaleSuccess",
	        data: formdata,
	        dataType: "json",
	        success: function(data){
	            if(data.success){//成功
	...
	form.on('submit(demo2)',function(data){
	    ...
	    $.ajax({
	        type: "POST",
	        url: "saleChance/updateSaleFaild",
	        data: formdata,
	        dataType: "json",
	        success: function(data){
	            if(data.success){//成功
